...
// export const useTransactCrypto = (
//   addChatMessages: (messages: MessageType[]) => void,
//   nextStep: (step: string) => void,
//   prevStep: () => void,
//   goToStep: (step: string) => void
...
//       }
//     },
//     [addChatMessages, nextStep, prevStep, setSharedPaymentMode]
//   );

//   // HANDLE ESTIMATE PAYMENT IN ASSET MENU
//   const handleEstimateAsset = useCallback(
...
//   const handlePayOptions = useCallback(
//     (chatInput: string) => {
//       if (greetings.includes(chatInput.trim().toLowerCase())) {
//         goToStep("start");
//         helloMenu(chatInput);
...
//   const handleBankAccountNumber = useCallback(
//     (chatInput: string) => {
//       if (greetings.includes(chatInput.trim().toLowerCase())) {
//         goToStep("start");
//         helloMenu(chatInput);
...
//                   type: "incoming",
//                   content: (
//                     <span>Invalid account number. Please try again.</span>
//                   ),
//                 },
//               ];
//               addChatMessages(newMessages);
...
//       }
//     },
//     [addChatMessages, nextStep, prevStep]
//   );
...
//       }
//     },
//     [addChatMessages, nextStep, goToStep, setSharedTransactionId]
//   );

//   // ALLOW USER TO START A NEW TRANSACTION OR CONTACT SUPPORT
//   const handleTransactionProcessing = useCallback(
//     async (chatInput: string) => {
//       if (greetings.includes(chatInput.trim().toLowerCase())) {
//         goToStep("start");
//         helloMenu(chatInput);
...
//       }
//     },
//     [addChatMessages, nextStep, prevStep, goToStep]
//   );
