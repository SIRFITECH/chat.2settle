...
//   //                 network={network}
//   //                 connectedWallet={walletIsConnected}
//   //               />
//   //             </div>
//   //           ),
//   //           timestamp: new Date(),
...
//        />
//      ),
//      [setLoading, sharedPaymentMode, processTransaction, walletIsConnected]
//    );
//    // final part to finish transaction
//    const handleCryptoPayment = async (chatInput: string) => {
//      const phoneNumber = chatInput.trim();
...
//          const newMessages: MessageType[] = walletIsConnected
//            ? [
//                {
//                  type: "incoming",
//                  content: (
//                    <div className="flex flex-col items-center">
//                      <p className="mb-4">
//                        You are going to be charged <b>{paymentAsset}</b>{" "}
//                        directly from your {sharedCrypto} ({sharedNetwork})
//                        wallet.
//                      </p>
...
//          if (sharedGiftId) {
//            const requestStatus = (await checkRequestExists(sharedGiftId))
//              .exists;
//            if (requestStatus) {
//            }
//          }
