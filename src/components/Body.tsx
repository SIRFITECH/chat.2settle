...
//     } catch (error) {
//       console.error("Failed to fetch rate:", error);
//       // Redirect to 404 page if there's an error fetching the rate
//       router.push("/404");
//     }
//   };
...
//   return (
//     <div className="relative min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100">
//       {loading ? (
//         <h2 className="font-Poppins text-black ">Loading Exchange rate...</h2>
//       ) : (
//         <div className="text-center">
...
//       {!approveLoading ? (
//         <button
//           className="bg-green-700 mt-4 p-2 rounded text-white hover:bg-green-800 transition-colors"
//           type="button"
//           onClick={handleApprove}
//         >
//           Approve transfer
