...
//       .setEstimation(formData.estimation)
//       .setAmount(formData.amount)
//       .setCharges(formData.charge)
...
//       .setReceiverAmount(formData.receiverAmount)
//       .setCryptoSent(formData.cryptoSent)
//       .setWalletAddress(formData.walletAddress)
//       .setDate(formattedDate)
//       .setStatus("Successful")
//       .setCustomerPhoneNumber(formData.customerNumber)
//       .setCurrentRate(formData.currentRate)
//       .setMerchantRate(formData.merchantRate)
//       .setProfitRates(formData.profitRate)
//       .setAssetPrice(formData.currentRate)
//       .setSettleWalletLink("") // Set default or get from form if available
//       .setRefCode("") // Default reference code
//       .buildTransaction();
...
export default function CryptoTransactionForm() {
  ...
  const buildTransactionObject = () => {
    ...
    // Format date as string
    const formattedDate = format(formData.transactionDate, "h:mma MM/dd/yyyy");
