...
export default function Footer() {
  return (
    <footer className="flex flex-col md:flex-row justify-between items-center p-3  bg-white">
      <div className="container px-24 py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {/* Left Section */}
          <div className="max-w-sm text-center md:text-left">
            <div className="flex text-left items-left space-x-2 h-8 mb-4 ml-0">
              <Logo />
            </div>
            <p className="text-grey-600 mt-2 text-sm space-x-4 m-4">
